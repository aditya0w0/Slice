...
<html>
    <head>
        ...
        <style>
            .step-inactive { opacity: 0.5; cursor: not-allowed; }
    ...
    <body class="bg-gray-50" data-auth-required="true">
        ...
        <main class="mx-auto max-w-[1400px] px-6 py-8 min-h-screen">
            <!-- Progress Steps -->
            <div class="mb-8 flex items-center justify-center gap-4">
                <div class="flex items-center gap-2 step-indicator" data-step="1">
                    <div class="step-circle flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-sm font-semibold text-white">1</div>
                    <span class="step-label font-medium text-gray-900">Delivery Info</span>
                </div>
                <div class="step-line h-px w-16 bg-gray-300"></div>
                <div class="flex items-center gap-2 step-indicator step-inactive" data-step="2">
                    <div class="step-circle flex h-8 w-8 items-center justify-center rounded-full bg-gray-300 text-sm font-semibold text-gray-600">2</div>
                    <span class="step-label font-medium text-gray-400">Payment</span>
                </div>
                <div class="step-line h-px w-16 bg-gray-300"></div>
                <div class="flex items-center gap-2 step-indicator step-inactive" data-step="3">
                    <div class="step-circle flex h-8 w-8 items-center justify-center rounded-full bg-gray-300 text-sm font-semibold text-gray-600">3</div>
            ...
            <div class="grid gap-8 lg:grid-cols-3 xl:grid-cols-5">
                ...
                <div class="lg:col-span-2 xl:col-span-3">
                    ...
                    <div class="content-section active" id="step-1">
                        <div class="rounded-2xl bg-white p-6 shadow-sm">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <button type="button" onclick="window.history.back()" class="text-gray-400 hover:text-gray-600">
                            ...
                            <div class="mb-6">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <button type="button" onclick="openAddressModal()" class="text-sm text-blue-600 hover:text-blue-700 flex items-center gap-1">
                                ...
                                <div id="selected-address" class="rounded-xl border-2 border-blue-500 bg-blue-50 p-4">
                                    <div class="flex items-start gap-3">
                                        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-blue-600 shrink-0">
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center gap-2 mb-1">
                                                ...
                                                <span class="px-2 py-0.5 bg-blue-600 text-white text-xs font-medium rounded-full">Selected</span>
                                            </div>
                                            <p id="address-display" class="text-sm text-gray-600 mb-2">
                                                @if(auth()->user()->address)
                                                    {{ auth()->user()->address }}@if(auth()->user()->city), {{ auth()->user()->city }}@endif @if(auth()->user()->zip_code){{ auth()->user()->zip_code }}@endif
                                                @else
                                                    Click "Change Address" to add your delivery location
                                                @endif
                                            </p>
                                            <p id="address-phone" class="text-sm text-gray-500 flex items-center gap-1">
                            ...
                            <div class="hidden">
                                ...
                                <input type="text" id="zip_code" value="{{ old('zip_code', auth()->user()->zip_code) }}"/>
                            ...
                            <button 
                                type="button" 
                                onclick="goToStep(2)" 
                                class="w-full rounded-xl bg-blue-600 px-8 py-3.5 font-semibold text-white hover:bg-blue-700 transition-all"
                            >
                                Continue to Payment
                            </button>
                        </div>
                    ...
                    <div class="content-section" id="step-2">
                        <div class="rounded-2xl bg-white p-6 shadow-sm">
                            ...
                            <!-- Credit Card Option -->
                            <div class="mb-4">
                                <button type="button" onclick="togglePaymentSection()" class="w-full flex items-center justify-between p-4 rounded-xl border-2 border-gray-300 hover:border-blue-500 transition-colors">
                                    <span class="font-medium text-gray-900">Credit Card</span>
                                    <svg id="payment-toggle-icon" class="h-5 w-5 text-gray-400 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                    </svg>
                                </button>
                                
                                <div id="payment-form" class="mt-4 space-y-4 hidden">
                                    <!-- Payment cards selection -->
                                    <div class="grid grid-cols-4 gap-3">
                                        <button type="button" class="payment-card-btn active aspect-square rounded-lg border-2 border-blue-600 bg-white p-3 hover:border-blue-600 transition-colors flex items-center justify-center">
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/5/5e/Visa_Inc._logo.svg" alt="VISA" class="h-6">
                                        </button>
                                        <button type="button" class="payment-card-btn aspect-square rounded-lg border-2 border-gray-200 bg-white p-3 hover:border-blue-600 transition-colors flex items-center justify-center">
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" alt="Mastercard" class="h-6">
                                        </button>
                                        <button type="button" class="payment-card-btn aspect-square rounded-lg border-2 border-gray-200 bg-white p-3 hover:border-blue-600 transition-colors flex items-center justify-center">
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/American_Express_logo_%282018%29.svg" alt="Citi" class="h-6">
                                        </button>
                                        <button type="button" class="payment-card-btn aspect-square rounded-lg border-2 border-gray-200 bg-white p-3 hover:border-blue-600 transition-colors flex items-center justify-center">
                                    ...
                                    <div class="grid gap-4 grid-cols-2">
                                        <div>
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <select id="exp_month" class="w-full rounded-lg border border-gray-300 px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
                                                    <option value="">MM</option>
                                                    @for($i = 1; $i <= 12; $i++)
                                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                    @endfor
                                                </select>
                                                <select id="exp_year" class="w-full rounded-lg border border-gray-300 px-3 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
                            ...
                            <div class="flex gap-3 pt-4">
                                <button 
                                    type="button" 
                                    onclick="goToStep(1)" 
                                    class="flex-1 rounded-xl border-2 border-gray-300 px-8 py-3.5 font-semibold text-gray-700 hover:bg-gray-50 transition-all"
                                >
                                    Back
                                </button>
                                <button 
                                    type="button" 
                                    onclick="goToStep(3)" 
                                    class="flex-1 rounded-xl bg-blue-600 px-8 py-3.5 font-semibold text-white hover:bg-blue-700 transition-all"
                                >
                                    Review Order
                                </button>
                            </div>
                        ...
                        <div class="rounded-2xl bg-white p-6 shadow-sm">
                                ...
                                <div class="border-b pb-4">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p id="review-card" class="text-sm text-gray-600">•••• •••• •••• ••••</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-6">
                                <label class="flex items-start gap-2 cursor-pointer">
                                    <input type="checkbox" id="terms-checkbox" class="mt-1 h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500" required/>
                                    <span class="text-sm text-gray-600">
                                        By clicking this, I agree to Slice's 
                                        <button type="button" onclick="showTermsModal()" class="text-blue-600 hover:underline">Terms & Conditions</button>
                                        and 
                            ...
                            <div class="flex gap-3">
                                ...
                                <button 
                                    type="button" 
                                    onclick="submitOrder()" 
                                    class="flex-1 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-3.5 font-semibold text-white shadow-lg hover:shadow-xl transition-all"
                                >
                                    Proceed to Payment
                                </button>
                            </div>
                ...
                <div class="lg:col-span-1 xl:col-span-2">
                    <div class="sticky top-6 max-h-[calc(100vh-3rem)] overflow-y-auto space-y-4">
                    <!-- Order Summary Card -->
                    <div class="rounded-2xl bg-white p-6 shadow-sm">
                        <!-- Device Card -->
                        <div class="mb-6 flex gap-4 pb-6 border-b">
                            @if($device->image)
                                <img src="{{ $device->image }}" alt="{{ $device->name }}" class="h-24 w-24 rounded-xl object-cover bg-gray-100"/>
                            @else
                            ...
                            <div class="flex-1">
                                ...
                                @if($capacity)
                                    <p class="text-sm text-gray-600 mt-1">Size: {{ $capacity }}</p>
                                @endif
                                <p class="text-lg font-bold text-gray-900 mt-2">Rp {{ number_format($device->price_monthly, 0, ',', '.') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="pt-4 border-t">
                            <p class="text-sm font-medium text-gray-900 mb-2">Do you have a promotional code?</p>
                            <div class="flex gap-2">
                                ...
                                />
                                <button class="rounded-lg bg-gray-900 px-6 py-2 text-sm font-semibold text-white hover:bg-gray-800 transition-colors">
                                    Apply
                                </button>
                            </div>
                        </div>
            ...
            <div class="mt-6">
                <div class="rounded-2xl bg-white shadow-sm overflow-hidden">
                    <div class="grid lg:grid-cols-3 divide-x divide-gray-100">
                        <!-- Rental Information -->
                        <div class="p-6">
        ...
        <div id="address-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 p-4">
            <div class="relative max-w-2xl w-full max-h-[85vh] rounded-3xl bg-white overflow-hidden flex flex-col">
                <!-- Modal Header -->
                ...
                <div class="p-6 border-t border-gray-200 bg-gray-50">
                    <button 
                        ...
                        class="w-full rounded-xl border-2 border-dashed border-gray-300 px-6 py-4 hover:border-blue-500 hover:bg-blue-50 transition-all flex items-center justify-center gap-2 text-gray-600 hover:text-blue-600"
                    >
        ...
        <div id="address-form-modal" class="fixed inset-0 z-[60] hidden items-center justify-center bg-black/50 p-4">
            <div class="relative max-w-lg w-full rounded-3xl bg-white p-8">
                <button onclick="closeAddressFormModal()" class="absolute right-4 top-4 text-gray-400 hover:text-gray-600">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                    </svg>
                </button>
                <h2 id="form-modal-title" class="text-2xl font-bold text-gray-900 mb-6">Add New Address</h2>
                
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Address Label</label>
                        <div class="grid grid-cols-3 gap-2">
                            <button type="button" onclick="selectAddressType('Home')" class="address-type-btn px-4 py-3 rounded-lg border-2 border-gray-300 hover:border-blue-500 transition-colors font-medium flex items-center justify-center gap-2" data-type="Home">
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                                </svg>
                                <span>Home</span>
                            </button>
                            <button type="button" onclick="selectAddressType('Office')" class="address-type-btn px-4 py-3 rounded-lg border-2 border-gray-300 hover:border-blue-500 transition-colors font-medium flex items-center justify-center gap-2" data-type="Office">
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                </svg>
                                <span>Office</span>
                            </button>
                            <button type="button" onclick="selectAddressType('Other')" class="address-type-btn px-4 py-3 rounded-lg border-2 border-gray-300 hover:border-blue-500 transition-colors font-medium flex items-center justify-center gap-2" data-type="Other">
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                                </svg>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="2"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2.5 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 resize-none"
                        ></textarea>
                    </div>
                    ...
                    <button 
                        ...
                        class="w-full rounded-xl bg-blue-600 px-8 py-3.5 font-semibold text-white hover:bg-blue-700 transition-all mt-6"
                    >
                        Save Address
                    </button>
                </div>
        ...
        <div id="terms-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 p-4">
            <div class="relative max-w-2xl w-full max-h-[80vh] rounded-3xl bg-white p-8 overflow-y-auto">
                <button onclick="closeTermsModal()" class="absolute right-4 top-4 text-gray-400 hover:text-gray-600">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                    </svg>
                </button>
                ...
                <div class="prose prose-sm max-w-none text-gray-600">
                    ...
                    <p>By renting a device from Slice, you agree to return the device in the same condition as received, normal wear and tear excepted.</p>
                    
                    <h3 class="font-semibold text-gray-900 mt-4">2. Payment Terms</h3>
                    <p>Payment is due at the time of booking. Monthly rental fees are non-refundable except as provided in our cancellation policy.</p>
                    
                    <h3 class="font-semibold text-gray-900 mt-4">3. Device Care</h3>
                    <p>You are responsible for the device during the rental period. Any damage beyond normal wear and tear may result in additional charges.</p>
                    
                    <h3 class="font-semibold text-gray-900 mt-4">4. Late Returns</h3>
                    <p>Late returns will incur additional daily charges. Please contact us if you need to extend your rental period.</p>
                    
                    <h3 class="font-semibold text-gray-900 mt-4">5. Cancellation</h3>
                    <p>Free cancellation up to 12 hours before pickup. Cancellations after this time may be subject to fees.</p>
                </div>
                <button onclick="closeTermsModal()" class="mt-6 w-full rounded-xl bg-blue-600 px-6 py-3 font-semibold text-white hover:bg-blue-700">
                    I Understand
                </button>
            </div>
        </div>
