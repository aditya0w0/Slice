    ...
    <div class="mx-auto max-w-7xl px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-1">
                <a href="{{ route('home') }}" class="text-xl font-semibold text-gray-900">SLICE</a>
                <p class="mt-4 text-sm text-gray-600">
                    Premium device rentals with flexible terms and intelligent credit system.
                </p>
            </div>

            <!-- Products -->
            <div>
                <h3 class="text-sm font-semibold text-gray-900 mb-4">Products</h3>
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('devices') }}" class="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                            Browse Devices
                        </a>
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('support') }}" class="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                            Support
                        </a>
                    </li>
                    @auth
        ...
        <div class="mt-12 pt-8 border-t border-gray-100">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-sm text-gray-500">
                    © {{ date('Y') }} Slice. All rights reserved.
                </p>
