            ...
            <div class="max-w-7xl mx-auto px-6">
                <div class="flex h-16 items-center justify-between">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 group">
                        <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center shadow-lg group-hover:shadow-blue-500/30 transition-all duration-300">
                            <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 10V3L4 14h7v7l9-11h-7z" />
                            </svg>
                        </div>
                        <span class="text-xl font-bold text-gray-900 tracking-tight">Slice<span class="text-blue-600">.</span></span>
                    </a>
                        ...
                        >
                            <div class="p-4">
                                ...
                                <div class="space-y-3 max-h-80 overflow-y-auto">
                                    ...
                                    <div class="p-3 rounded-lg {{ $notif->read_at ? 'bg-gray-50 border border-gray-100' : 'bg-blue-50 border border-blue-200' }} hover:bg-gray-100 transition-colors cursor-pointer">
                                        <div class="flex items-start justify-between">
                                            <div class="flex-1 min-w-0">
                                                <p class="text-sm font-medium text-gray-900 truncate">{{ $notif->data['title'] ?? 'Notification' }}</p>
                                                <p class="text-sm text-gray-600 mt-1 line-clamp-2">{{ $notif->data['message'] ?? '' }}</p>
                                ...
                                <div class="mt-4 pt-3 border-t border-gray-200">
                                    <a href="{{ route('admin.notifications.index') }}" class="block w-full text-center px-4 py-2 text-sm font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-colors">
        ...
        <main class="mx-auto max-w-7xl px-6 py-8">
                ...
                <div class="flex items-center gap-4" x-data="{ open: false }">
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            >
                            @if($user->is_admin)
                                <div class="absolute -bottom-0.5 -right-0.5 h-4 w-4 rounded-full bg-purple-500 ring-2 ring-white flex items-center justify-center">
                        ...
                        >
                            <div class="p-2">
                                <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                                    <svg class="w-4 h-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    </svg>
                                    User Dashboard
                                </a>
                                <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                                    <svg class="w-4 h-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                    </svg>
                                    Manage Users
                                </a>
                                <a href="{{ route('admin.chat.index') }}" class="flex items-center gap-3 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                                    <svg class="w-4 h-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" class="flex w-full items-center gap-3 px-3 py-2 text-sm text-red-600 hover:bg-red-50 rounded-lg transition-colors">
            ...
            <div class="mb-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-900/5">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <p class="text-xs font-medium text-gray-500">Total Notifications</p>
                            <p class="mt-1 text-3xl font-semibold text-gray-900">{{ number_format($stats["total_notifications"]) }}</p>
                            <p class="mt-1 text-xs text-blue-600">{{ number_format($stats["unread_notifications"]) }} unread</p>
                        </div>
                ...
                <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-900/5">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <p class="text-xs font-medium text-gray-500">Support Messages</p>
                            <p class="mt-1 text-3xl font-semibold text-gray-900">{{ number_format($stats["total_support_messages"]) }}</p>
                            <p class="mt-1 text-xs text-green-600">{{ number_format($stats["unread_support_messages"]) }} unread</p>
                        </div>
            ...
            <div class="mb-6">
                ...
                <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    >
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-900">Send Notifications</p>
                            <p class="text-xs text-gray-500">Broadcast messages</p>
                        </div>
                    </a>
                    ...
                    >
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-900">Support Chats</p>
                            <p class="text-xs text-gray-500">User conversations</p>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="mt-6 grid gap-6 lg:grid-cols-2">
                ...
                <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-900/5">
                    ...
                    <div class="divide-y divide-gray-100">
                        @php
                            $recentNotifications = \App\Models\Notification::with('user')->orderBy('created_at', 'desc')->limit(5)->get();
                        @endphp
                        ...
                        <div class="px-5 py-4 hover:bg-gray-50">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-gray-600 mt-1 line-clamp-2">{{ Str::limit($notification->message, 80) }}</p>
                                    <div class="flex items-center gap-2 mt-2">
                                        <span class="text-xs text-gray-500">To: {{ $notification->user->name ?? 'Unknown' }}</span>
                ...
                <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-900/5">
                    <div class="border-b border-gray-100 px-5 py-3">
                        <div class="flex items-center justify-between">
                            <h2 class="text-base font-semibold text-gray-900">Recent Support Messages</h2>
                            <a
                    ...
                    <div class="divide-y divide-gray-100">
                        @php
                            $recentMessages = \App\Models\SupportMessage::with('user')->orderBy('created_at', 'desc')->limit(5)->get();
                        @endphp
                        ...
                        <div class="px-5 py-4 hover:bg-gray-50">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-gray-600 mt-1 line-clamp-2">{{ Str::limit($message->message, 80) }}</p>
                                    <div class="flex items-center gap-2 mt-2">
                                        <span class="text-xs text-gray-500 capitalize">{{ $message->sender_type }}</span>
                        ...
                        <div class="px-5 py-8 text-center">
                            ...
                            <p class="text-sm text-gray-500">No support messages yet</p>
                        </div>
                        @endforelse
                    </div>
                </div>
