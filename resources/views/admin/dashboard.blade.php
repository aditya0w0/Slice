    ...
    <body class="bg-gray-50">
        ...
        <main class="mx-auto max-w-7xl px-6 py-12">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <div
                        class="mb-2 inline-flex items-center gap-2 rounded-full bg-blue-100 px-4 py-1.5 text-sm font-semibold text-blue-800"
                    >
            ...
            <div class="mb-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <!-- Total Revenue -->
                <div
                    class="group overflow-hidden rounded-3xl bg-gradient-to-br from-green-500 to-emerald-600 p-6 shadow-lg transition-transform hover:scale-105"
                >
                ...
                <!-- Total Orders -->
                <div
                    class="group overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 shadow-lg transition-transform hover:scale-105"
                >
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                ...
                <!-- Total Users -->
                <div
                    class="group overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500 to-purple-600 p-6 shadow-lg transition-transform hover:scale-105"
                >
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                ...
                <!-- Total Devices -->
                <div
                    class="group overflow-hidden rounded-3xl bg-gradient-to-br from-pink-500 to-rose-600 p-6 shadow-lg transition-transform hover:scale-105"
                >
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                ...
                <!-- Pending Orders -->
                <div
                    class="group overflow-hidden rounded-3xl bg-gradient-to-br from-orange-500 to-amber-600 p-6 shadow-lg transition-transform hover:scale-105"
                >
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                ...
                <!-- Active Rentals -->
                <div
                    class="group overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-500 to-blue-600 p-6 shadow-lg transition-transform hover:scale-105"
                >
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
            ...
            <div class="mb-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <a
                    ...
                    class="group flex items-center gap-4 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5 transition hover:shadow-md"
                >
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($recentOrders as $order)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-mono font-medium text-gray-700">
                                            {{ $order->device?->sku ?? '—' }}
                                        </span>
                                    </td>
