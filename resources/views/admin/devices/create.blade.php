                ...
                <form method="POST" action="{{ route("admin.devices.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="mx-auto max-w-2xl">
                            ...
                            <div class="space-y-8">
                                ...
                                <div>
                                    <label
                                        for="category"
                                        class="mb-3 block text-center text-sm font-medium text-gray-900"
                                    >
                                        Product Category
                                    </label>
                                    <div class="flex justify-center">
                                        <select
                                            name="category"
                                            id="category"
                                            class="w-full max-w-xs rounded-xl border-0 bg-gray-50 px-4 py-3 text-center text-gray-900 ring-1 ring-gray-300 ring-inset focus:ring-2 focus:ring-blue-600 focus:ring-inset sm:text-sm"
                                        >
                                            <option value="" class="text-center">Choose Category</option>
                                            <option value="iPhone" {{ old("category") == "iPhone" ? "selected" : "" }}>
                                                📱 iPhone
                                            </option>
                                            <option value="iPad" {{ old("category") == "iPad" ? "selected" : "" }}>
                                                📱 iPad
                                            </option>
                                            <option value="Mac" {{ old("category") == "Mac" ? "selected" : "" }}>
                                                💻 Mac
                                            </option>
                                            <option
                                                value="Apple Watch"
                                                {{ old("category") == "Apple Watch" ? "selected" : "" }}
                                            >
                                                ⌚ Apple Watch
                                            </option>
                                            <option
                                                value="Apple TV"
                                                {{ old("category") == "Apple TV" ? "selected" : "" }}
                                            >
                                                📺 Apple TV
                                            </option>
                                            <option
                                ...
                                <!-- Name -->
                                <div>
                                    <label for="name" class="mb-3 block text-center text-sm font-medium text-gray-900">
                                        Device Name
                                    </label>
                                    <div class="flex justify-center">
                                        <input
                                            ...
                                            value="{{ old("name") }}"
                                            required
                                            class="w-full max-w-md rounded-xl border-0 bg-gray-50 px-4 py-3 text-center text-gray-900 ring-1 ring-gray-300 ring-inset placeholder:text-center placeholder:text-gray-400 focus:ring-2 focus:ring-blue-600 focus:ring-inset sm:text-sm"
                    ...
                    <div class="bg-gray-50 px-8 py-12">
                        <div class="mx-auto max-w-2xl">
                                ...
                                <div>
                                    ...
                                    <div class="flex justify-center">
                                        <input
                                            ...
                                            list="families"
                                            value="{{ old("family") }}"
                                            class="w-full max-w-xs rounded-xl border-0 bg-white px-4 py-3 text-center text-gray-900 ring-1 ring-gray-300 ring-inset placeholder:text-center focus:ring-2 focus:ring-blue-600 focus:ring-inset sm:text-sm"
                                    ...
                                    <p class="mt-2 text-center text-xs text-gray-500">Leave empty for auto-detection</p>
                                    @error("family")
                                        <p class="mt-2 text-center text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                    ...
                                    <div class="flex justify-center">
                                        <div class="relative w-full max-w-xs">
                                            ...
                                            <input
                                                ...
                                                step="0.01"
                                                min="0"
                                                class="w-full rounded-xl border-0 bg-white py-3 pr-4 pl-8 text-center text-gray-900 ring-1 ring-gray-300 ring-inset placeholder:text-center focus:ring-2 focus:ring-blue-600 focus:ring-inset sm:text-sm"
                                                placeholder="29.99"
                                            />
                                        </div>
                                    </div>
                            ...
                            <!-- Variant Preview -->
                            <div class="mt-8">
                                <label class="mb-4 block text-center text-sm font-medium text-gray-900">
                                    Live Preview
                                </label>
                                <div class="flex justify-center">
                                    <div class="rounded-xl bg-white p-6 ring-1 ring-gray-200">
                                        <div class="flex items-center gap-6">
                                            <div class="text-center">
                                                <div class="mb-1 text-sm text-gray-600">Variant</div>
                                                <span
                                                    id="variant-preview"
                                            ...
                                            <div class="text-center">
                                                <div class="mb-1 text-sm text-gray-600">Family</div>
                                                <div
                                                    id="family-preview"
                                                    class="min-w-[120px] text-sm font-medium text-gray-900"
                                                >
                                                    Auto-detected
                                                </div>
                                            </div>
                        ...
                        <div class="mx-auto max-w-2xl">
                            <div class="mb-8 text-center">
                                ...
                                <p class="mt-2 text-gray-600">
                                    Provide detailed information about features and specifications
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex justify-center">
                                    <textarea
                                        ...
                                        name="description"
                                        rows="8"
                                        class="w-full max-w-2xl rounded-xl border-0 bg-gray-50 px-4 py-3 text-gray-900 ring-1 ring-gray-300 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-blue-600 focus:ring-inset sm:text-sm"
                            ...
                            <div>
                                ...
                                <div class="flex justify-center">
                                    <div class="w-full max-w-md">
                                        <div
                                            class="flex justify-center rounded-xl border-2 border-dashed border-gray-300 bg-white px-6 py-10 transition-colors hover:border-gray-400"
                                            id="drop-zone"
                                        >
                                            <div class="text-center">
                                                <!-- Preview Image -->
                                                <img
                                                    id="image-preview"
                                                    class="mx-auto mb-4 hidden max-h-48 rounded-lg object-contain"
                                                    alt="Preview"
                                                />
