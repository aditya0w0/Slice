                    ...
                    <div class="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-gray-900/5">
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-lg font-semibold text-gray-900">
                                    Rp {{ number_format($device->price_monthly ?? 0, 0, ",", ".") }}
                                </p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Daily Price</label>
                                <p class="mt-1 text-lg font-semibold text-gray-900">
                                    Rp {{ number_format($device->price_daily ?? 0, 0, ",", ".") }}
                                </p>
                            </div>
                        </div>
                        ...
                        @if ($device->specifications)
                            <div class="mt-6">
                                ...
                                <div class="mt-1 rounded-lg bg-gray-50 p-4 text-gray-900">
                            ...
                            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                                @foreach ($device->images as $image)
                                    <div class="relative">
                                        ...
                                        @if ($image->is_primary)
                                            <span
                                                class="absolute top-2 left-2 inline-flex items-center rounded-full bg-blue-100 px-2 py-1 text-xs font-medium text-blue-800"
                                            >
                                                Primary
                                            </span>
                                        @endif
                                        ...
                                        @foreach ($device->variants as $variant)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 text-sm whitespace-nowrap text-gray-900">
                                                    Rp {{ number_format($variant->price_monthly ?? 0, 0, ",", ".") }}
                                                </td>
                                                <td class="px-6 py-4 text-sm whitespace-nowrap text-gray-500">
                                                    {{ $variant->stock ?? 0 }}
                                                </td>
                        ...
                        <div class="space-y-4">
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold text-gray-900">
                                    {{ $device->variants ? $device->variants->count() : 0 }}
                                </span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Total Images</span>
                                <span class="font-semibold text-gray-900">
                                    {{ $device->images ? $device->images->count() : 0 }}
                                </span>
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold text-gray-900">
                                    {{ $device->updated_at->format("M j, Y") }}
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-3">
                            ...
                            >
                                ...
                                <button
                                    ...
                                    class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-red-600 px-4 py-3 font-medium text-white shadow-lg shadow-red-500/30 transition hover:bg-red-700"
                                >
                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path
                                            stroke-linecap="round"
