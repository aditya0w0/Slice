                ...
                <form method="POST" action="{{ route("admin.devices.update", $device) }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            required
                            class="w-full rounded-xl border border-gray-200 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none"
                    ...
                    <!-- Slug -->
                    <div class="mb-6">
                        <label for="slug" class="mb-2 block text-sm font-semibold text-gray-900">
                            Slug (URL-friendly) *
                        </label>
                        <input
                            type="text"
                            name="slug"
                            id="slug"
                            value="{{ old("slug", $device->slug) }}"
                            required
                            class="w-full rounded-xl border border-gray-200 px-4 py-3 font-mono text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none"
                            placeholder="e.g., iphone-15-pro-max"
                        />
                    ...
                    <!-- Price -->
                    <div class="mb-6">
                        <label for="price" class="mb-2 block text-sm font-semibold text-gray-900">
                            Monthly Price ($) *
                        </label>
                        <div class="relative">
                            ...
                            <input
                                ...
                                step="0.01"
                                min="0"
                                class="w-full rounded-xl border border-gray-200 px-4 py-3 pl-8 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none"
                                placeholder="49.99"
                            />
                        </div>
                        @error("price")
...
{{ old("description", $device->description) }}</textarea
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a
                            href="{{ route("admin.devices.index") }}"
                            class="inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-6 py-3 font-medium text-gray-700 transition hover:bg-gray-50"
                        >
                            Cancel
                        </a>
                    </div>
