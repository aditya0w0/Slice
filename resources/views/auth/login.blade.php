            ...
            >
                <div class="mx-auto w-full max-w-sm lg:w-96">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-400">Enter your credentials to access your workspace.</p>
                    </div>
            ...
            <div class="relative hidden w-0 flex-1 lg:block">
                <div class="absolute inset-0 overflow-hidden bg-[#0B0C10]">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div
                            class="relative w-[80%] max-w-2xl rotate-[-5deg] transform transition-transform duration-1000 hover:rotate-0"
                        >
                            <div class="glass-panel rounded-2xl p-6 shadow-2xl shadow-blue-900/40">
                                <div class="mb-6 flex items-center space-x-4 border-b border-white/10 pb-4">
                                    <div class="h-3 w-3 rounded-full bg-red-500"></div>
                                    <div class="h-3 w-3 rounded-full bg-yellow-500"></div>
                                    <div class="h-3 w-3 rounded-full bg-green-500"></div>
                                </div>
                                <div class="animate-pulse space-y-4">
                                    <div class="h-8 w-1/3 rounded bg-white/10"></div>
                                    <div class="grid grid-cols-3 gap-4">
                                        <div class="h-24 rounded-xl border border-white/5 bg-white/5"></div>
                                        <div class="h-24 rounded-xl border border-white/5 bg-white/5"></div>
                                        <div class="h-24 rounded-xl border border-white/5 bg-white/5"></div>
                                    </div>
