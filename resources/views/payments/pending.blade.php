    ...
    <body
        ...
        x-data="{
            ...
            init() {
                ...
                // Auto-expand details after 1 second
                setTimeout(() => { this.detailsExpanded = true }, 1000)
            },
        }"
    >
            ...
            <div class="fade-in-up mb-6 rounded-2xl bg-white p-8 shadow-sm" style="animation-delay: 0.5s">
                ...
                <div class="space-y-4">
                    ...
                    <a
                        ...
                        class="flex items-center gap-4 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 p-4 transition-all hover:shadow-md hover:scale-[1.02] cursor-pointer group"
                    >
                        <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-green-100 group-hover:bg-green-200 transition-colors">
                        ...
                        <div class="flex-1">
                            <h3 class="mb-1 font-semibold text-gray-900 group-hover:text-green-700 transition-colors">Track Delivery Status</h3>
                            <p class="text-sm text-gray-600">Click to view real-time delivery tracking →</p>
                        </div>
                    </a>
                </div>
            </div>

            <!-- Order Details Card with Alpine.js Animation -->
            <div 
                class="fade-in-up mb-6 rounded-2xl bg-white shadow-sm overflow-hidden" 
                style="animation-delay: 0.7s"
                x-data="{ expanded: false }"
                x-init="setTimeout(() => expanded = true, 800)"
            >
                <button
                    @click="expanded = !expanded"
                    class="w-full px-8 py-6 text-left hover:bg-gray-50 transition-colors"
                >
                ...
                >
                    <div class="space-y-4">
                        <div class="flex justify-between text-sm" x-data="{}" x-init="$el.style.transitionDelay = '0ms'" style="opacity: 0" x-transition.opacity.duration.500ms>
                            <span class="text-gray-600">Order Number</span>
                            <span class="font-semibold text-gray-900">{{ $orderNumber }}</span>
                        </div>
                        <div class="flex justify-between text-sm" x-data="{}" x-init="setTimeout(() => $el.style.opacity = '1', 100)" style="opacity: 0; transition: opacity 0.5s">
                            <span class="text-gray-600">Device</span>
                            <span class="font-semibold text-gray-900">{{ $device }}</span>
                        </div>
                        <div class="flex justify-between text-sm" x-data="{}" x-init="setTimeout(() => $el.style.opacity = '1', 200)" style="opacity: 0; transition: opacity 0.5s">
                            <span class="text-gray-600">Rental Duration</span>
                            <span class="font-semibold text-gray-900">{{ $duration }} months</span>
                        </div>
                        <div class="flex justify-between text-sm" x-data="{}" x-init="setTimeout(() => $el.style.opacity = '1', 300)" style="opacity: 0; transition: opacity 0.5s">
                            <span class="text-gray-600">Total Payment</span>
                            <span class="font-semibold text-gray-900">Rp {{ number_format($total, 0, ",", ".") }}</span>
                        </div>
                        <div class="flex justify-between text-sm" x-data="{}" x-init="setTimeout(() => $el.style.opacity = '1', 400)" style="opacity: 0; transition: opacity 0.5s">
                        ...
                        <div class="flex justify-between text-sm" x-data="{}" x-init="setTimeout(() => $el.style.opacity = '1', 500)" style="opacity: 0; transition: opacity 0.5s">
