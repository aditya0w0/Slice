...
<html lang="en">
    ...
    <body class="bg-gray-50 text-gray-900" data-auth-required="true">
        ...
        <main class="mx-auto max-w-7xl px-6 py-12">
            ...
            <div class="mb-12 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div
                    class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500 to-blue-600 p-8 shadow-lg transition-transform hover:scale-105"
                >
                ...
                <div
                    class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500 to-purple-600 p-8 shadow-lg transition-transform hover:scale-105"
                >
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <div
                    class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-pink-500 to-pink-600 p-8 shadow-lg transition-transform hover:scale-105"
                >
                    <div class="flex items-center justify-between">
                        <div>
                        ...
                        <div class="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-gray-900/5">
                            <div class="p-8">
                                <div class="flex items-start justify-between">
                                    ...
                                    <div
                                        class="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200"
                                    >
                                ...
                                <div class="mt-8 flex gap-3">
                                    <a
                                        ...
                                        class="inline-flex items-center rounded-full bg-blue-600 px-6 py-3 text-sm font-medium text-white shadow-lg shadow-blue-500/30 transition hover:bg-blue-700"
                                    >
                                        View Details
                                    ...
                                    <button
                                        class="inline-flex items-center rounded-full border border-gray-200 bg-white px-6 py-3 text-sm font-medium text-gray-700 transition hover:bg-gray-50"
                                    >
                                        Extend Rental
                                    </button>
                                </div>
            ...
            <div class="mt-12">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    <div
                        class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 p-8 shadow-lg transition hover:scale-105"
                    >
                    ...
                    <div
                        class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500 to-cyan-500 p-8 shadow-lg transition hover:scale-105"
                    >
                    ...
                    <div
                        class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500 to-pink-500 p-8 shadow-lg transition hover:scale-105"
                    >
                    ...
                    <div
                        class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-red-500 to-orange-500 p-8 shadow-lg transition hover:scale-105"
                    >
