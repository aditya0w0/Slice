...
<html lang="en">
    ...
    <body class="bg-gray-50">
        ...
        <main class="mx-auto max-w-5xl px-6 py-12">
            <!-- Back button -->
            <div class="mb-8">
                <a href="{{ route('dashboard') }}" class="inline-flex items-center text-sm font-medium text-gray-600 transition hover:text-gray-900">
            ...
            <div class="mb-8">
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-400">Placed {{ $order->created_at->format('F j, Y \a\t g:i A') }}</p>
                    </div>
            ...
            <div class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-gray-900/5">
                        <div class="p-8">
                            <h2 class="text-sm font-semibold uppercase tracking-wider text-gray-500">Device</h2>
                            <div class="mt-6 flex items-start gap-6">
                                <!-- Device Image/Icon -->
                                <div class="flex h-24 w-24 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-100 to-blue-200">
                                    @php
                    ...
                    <div class="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-gray-900/5">
                        <div class="p-8">
                            <h2 class="text-sm font-semibold uppercase tracking-wider text-gray-500">Order Timeline</h2>
                            <div class="mt-6 space-y-6">
                                <div class="flex gap-4">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <div class="h-full w-px bg-gray-200 mt-2"></div>
                                    </div>
                                ...
                                <div class="flex gap-4">
                                    <div class="flex flex-col items-center">
                                        <div class="flex h-10 w-10 items-center justify-center rounded-full {{ $order->status !== 'created' ? 'bg-green-100' : 'bg-gray-100' }}">
                                            <svg class="h-5 w-5 {{ $order->status !== 'created' ? 'text-green-600' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="flex-1 pb-8">
                                        ...
                                        <p class="text-sm text-gray-500">{{ $order->status !== 'created' ? 'Completed' : 'Pending' }}</p>
                                    </div>
                                </div>

                                <div class="flex gap-4">
                                    <div class="flex flex-col items-center">
                                        <div class="flex h-10 w-10 items-center justify-center rounded-full {{ $order->status === 'active' || $order->status === 'completed' ? 'bg-green-100' : 'bg-gray-100' }}">
                                            <svg class="h-5 w-5 {{ $order->status === 'active' || $order->status === 'completed' ? 'text-green-600' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-500">{{ $order->status === 'active' || $order->status === 'completed' ? 'Delivered' : 'Pending' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-gray-900/5">
                        <div class="p-6">
                            <h2 class="text-sm font-semibold uppercase tracking-wider text-gray-500">Summary</h2>
                    ...
                    <div class="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-gray-900/5">
                        <div class="p-6">
                            <h2 class="text-sm font-semibold uppercase tracking-wider text-gray-500">Actions</h2>
                            <div class="mt-4 space-y-3">
                                <button class="flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-sm font-medium text-white shadow-lg shadow-blue-500/30 transition hover:bg-blue-700">
                                ...
                                <button class="flex w-full items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-700 transition hover:bg-gray-50">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
